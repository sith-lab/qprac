...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/scratch/st-prashnr-1/jeonghyun/QPRAC/AE/qprac/perf_analysis/ext/argparse'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/scratch/st-prashnr-1/jeonghyun/QPRAC/AE/qprac/perf_analysis/ext/argparse'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

...
echo "[INFO] Generating simulation configurations and run scripts for Queue Hit Rates Using Personal Server"
python3 "$PWD/sim_scripts/setup_ps_cache_hit.py" \
...
echo "[INFO] Starting simulations for Queue Hit Rate"
python3 "$PWD/sim_scripts/execute_run_script_cache_hit.py"
...
echo "[INFO] Generating simulation configurations and run scripts for Figure 16"
python3 "$PWD/sim_scripts/setup_slurm_fig16.py" \
...
python3 "$PWD/sim_scripts/execute_run_script_fig16.py" --slurm

echo "[INFO] Fired all simulations for Figure 16, this can take ~16 hours to complete."
rm "$PWD/run.sh" 
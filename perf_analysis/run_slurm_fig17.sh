...
echo "[INFO] Generating simulation configurations and run scripts for Figure 17 using Slurm"
python3 "$PWD/sim_scripts/setup_slurm_fig17.py" \
...
python3 "$PWD/sim_scripts/execute_run_script_fig17.py" --slurm

echo "[INFO] Fired all simulations for Figure 17, this can take ~16 hours to complete."
rm "$PWD/run.sh" 
...
echo "[INFO] Generating simulation configurations and run scripts for Figure 18 using Slurm"
python3 "$PWD/sim_scripts/setup_slurm_fig18.py" \
...
echo "[INFO] Starting simulations for Figure 18"
python3 "$PWD/sim_scripts/execute_run_script_fig18.py" --slurm

echo "[INFO] Fired all simulations for Figure 18, this can take ~16 hours to complete."
rm "$PWD/run.sh" 
...
class BHO3Core: public Clocked<BHO3Core> {
  ...
  class InstWindow {
    ...
    private:
      ...
      uint64_t m_load = 0;         // The current load
    ...
    public:
      ...
      // For debug
      uint64_t print_m_load();
      void print_m_addr_list();
  };
  ...
  public:
    ...
    uint64_t s_insts_retired = 0; 
    uint64_t s_cycles_recorded = 0; 
    uint64_t s_insts_recorded = 0;
    Clk_t  s_mem_access_cycles = 0; 
    uint64_t s_mem_requests_issued = 0;

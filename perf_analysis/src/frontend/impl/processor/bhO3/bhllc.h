...
class BHO3LLC : public Clocked<BHO3LLC> {
  ...
  public:
    ...
    uint64_t s_llc_read_access = 0;
    uint64_t s_llc_write_access = 0;
    uint64_t s_llc_read_misses = 0;
    uint64_t s_llc_write_misses = 0;
    uint64_t s_llc_eviction = 0;
    uint64_t s_llc_mshr_unavailable = 0;
    uint64_t s_llc_mshr_blacklisted = 0;

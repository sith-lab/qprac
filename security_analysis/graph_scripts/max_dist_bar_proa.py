...
plt.bar(r1, values1, width=bar_width, color='lightgrey', label='PRAC-1', edgecolor = "black", linewidth=1.5)
plt.bar(r2, values2, width=bar_width, color='grey', label='PRAC-2', edgecolor = "black", linewidth=1.5)
plt.bar(r3, values3, width=bar_width, color='black', label='PRAC-4', edgecolor = "black", linewidth=1.5)
plt.bar(r4, values4, width=bar_width, label='PRAC-1 Proactive', edgecolor = "black", linewidth=1.5)
plt.bar(r5, values5, width=bar_width, label='PRAC-2 Proactive', edgecolor = "black", linewidth=1.5)
plt.bar(r6, values6, width=bar_width, label='PRAC-4 Proactive', edgecolor = "black", linewidth=1.5)
...
fig.savefig("Graphs/Nonline_vs_NBO_PROA.pdf", transparent=True, format="pdf", bbox_inches="tight")

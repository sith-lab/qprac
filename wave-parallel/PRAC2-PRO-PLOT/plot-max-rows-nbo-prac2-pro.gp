...
set output 'plot-max-rows-nbo-prac2-pro.pdf'

# Set labels for axes
set xlabel 'Row Pool Size (PRAC-PROACTIVE-2)' font 'Times,14'
...
files = "~/PRAC/NBO1/NBO1-prac2-pro.txt ~/PRAC/NBO2/NBO2-prac2-pro.txt ~/PRAC/NBO4/NBO4-prac2-pro.txt ~/PRAC/NBO8/NBO8-prac2-pro.txt ~/PRAC/NBO16/NBO16-prac2-pro.txt ~/PRAC/NBO32/NBO32-prac2-pro.txt ~/PRAC/NBO64/NBO64-prac2-pro.txt ~/PRAC/NBO128/NBO128-prac2-pro.txt ~/PRAC/NBO256/NBO256-prac2-pro.txt"

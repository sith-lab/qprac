...
set output 'plot-max-rows-nbo-prac4-pro.pdf'

# Set labels for axes
set xlabel 'Row Pool Size (PRAC-PROACTIVE-4)' font 'Times,14'
...
files = "~/PRAC/NBO1/NBO1-prac4-pro.txt ~/PRAC/NBO2/NBO2-prac4-pro.txt ~/PRAC/NBO4/NBO4-prac4-pro.txt ~/PRAC/NBO8/NBO8-prac4-pro.txt ~/PRAC/NBO16/NBO16-prac4-pro.txt ~/PRAC/NBO32/NBO32-prac4-pro.txt ~/PRAC/NBO64/NBO64-prac4-pro.txt ~/PRAC/NBO128/NBO128-prac4-pro.txt ~/PRAC/NBO256/NBO256-prac4-pro.txt"
